...
% Return a cell array of the graphs (in adjacency matrix form) and also the number of steps performed.
...
function [graphs,i] = dgmtrigger(B,A,dtarget,slowness,dtrigger,period)
    n = size(A,1);
